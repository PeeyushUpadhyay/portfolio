...
import profileimg from '../Assets/IMG_20210914_130303~2.jpg'
          ...
          <div className="mx-auto -my-10 max-w-2xl py-32 sm:py-24 lg:py-24 md:py-24">
            <div className="text-center">
              <div className="flex justify-center items-center">
                <img className="rounded-full w-56 h-56 shadow-2xl object-contain shadow-purple-900 " src={profileimg} alt="profileimg" />
              </div>
              <h1 className="text-3xl tracking-tight text-gray-200 sm:text-5xl mt-5 cursor-default font-bold">
                Hello Everyone<span className="emoji">👋</span><br></br>I Am Peeyush Upadhyay
              </h1>
              <p className="mt-6 text-xl leading-8 text-gray-200 font-bold relative">
                I Am a <span className="text-blue-500 ">{text}</span><span className="text-blue-500"><Cursor/></span> 
              </p>
