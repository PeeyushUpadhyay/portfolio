...
const Footer = () => {
  return (
    <div>
      <div className="relative bg-gradient-to-b from-gray-400 via-gray-500 to-gray-700  pt-8 pb-6 cursor-default">
          ...
          <div className="flex flex-wrap text-left lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <div className="mt-6 lg:mb-0 mb-6">
                <a href="linkedin.com/in/peeyush-upadhyay-52834a25b" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://github.com/PeeyushUpadhyay" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://wa.me/8171067881" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.instagram.com/____peeyush__/" target="_blank" rel="noopener noreferrer">
                  <button className="bg-white hover:scale-110 duration-500 shadow-lg h-10 w-10 rounded-full outline-none focus:outline-none mr-2" type="button">
          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="text-sm text-blueGray-500 font-semibold py-1">
                Copyright © <span id="get-current-year">2023 Portfolio by Peeyush Upadhyay</span>
              </div>
            </div>
          </div>
        </div>
