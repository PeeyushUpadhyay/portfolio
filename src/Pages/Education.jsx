...
const Education = () => {
  const edu = [
    {
      ...
      year: 2014,
      title: 'High school',
      description: 'I have completed my 10th from Vivekanand Vidhya Mandir Didihat (Uttarakhand)',
    ...
    },
    {
      ...
      year: 2016,
      title: 'Intermediate',
      description: 'I have completed my 12th from Government Inter College Didihat (Uttarakhand)',
      style: 'shadow-blue-500',
      icon : <FontAwesomeIcon icon={faSchool} style={{color: "#8004b9",}} />,
    },
    {
      ...
      year: 2020,
      title: 'BSc',
      description: 'I have completed my graduation from LSM Govt. College Pithoragarh (Uttarakhand)',
      style: 'shadow-blue-500',
    ...
    },
    {
      ...
      year: 2024,
      title: 'MCA',
      description: 'At present I am pursuing my post graduation from Amrapali Institute of Technology and Science Haldwani (Uttarakhand)',
      style: 'shadow-blue-500',
      icon : <FontAwesomeIcon icon={faGraduationCap} style={{color: "#8004b9",}} />,
    },
  ];
  return (
    <div>
      ...
      <div id='education' className='py-12 bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 cursor-default'>
