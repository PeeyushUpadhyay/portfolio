...
import reacticn from '../Assets/reactjs.png'
import sqlicn from '../Assets/mysql.png'
import bootstrpicn from '../Assets/bootstrap.png'
import nodeicn from '../Assets/nodejs.png'
            ...
            <div id="skills" className='py-12 bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 ... ' >
                ...
                <div className='max-w-screen-lg mx-auto p-2  flex flex-col justify-center w-full '>
                    ...
                    <div>
                        ...
                        <p className='text-3xl text-gray-200 font-bold border-b-4 border-gray-500 p-2  inline cursor-default'>My Skills</p>
                    </div>
...

                        {
                            skill.map(({ id, title, style, src }) => (
                                <div
                                    ...
                                    <p className='mt-4 font-bold cursor-default'>{title}</p>
                                </div>
                            ))
                        }
