  ...
  return (
    <div>
      ...
      <div id="about" className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 cursor-default">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-8 text-lg leading-8 text-gray-300">
              Hello! I'm Peeyush Upadhyay, a passionate and dedicated Web Developer  with a strong commitment to crafting exceptional digital experiences.
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">As a Web Developer, I have honed my skills in
              ...
              I create not only visually appealing but also perform seamlessly under the hood.
              My proficiency includes HTML, CSS, JavaScript, Python, Reactjs and more.
