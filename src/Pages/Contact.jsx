...
const Contact = () => {
  ...
  const handleSubmit=(e)=>{
    e.preventDefault()
    toast.success("Message Send Successfully",{autoClose : 2000});
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold text-gray-200">
                      Email Address
                    </h4>
                    <p className="text-base text-gray-300">
                      peeyushupadhyay7@gmail.com
                    </p>
                  </div>
                </div>
              </div>
                ...
                <form ref={formRef} onSubmit={handleSubmit}>
                  ...
                  <div>
                    <button
                      ...
                      className="w-full p-3 text-white transition border rounded border-primary bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 ... hover:bg-opacity-90"
